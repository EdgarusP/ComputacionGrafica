...
public:
	...
	virtual void OnRender(void)
	{
		...
		if (shader) shader->begin();
			...
			glmDraw(sphere, GLM_SMOOTH | GLM_MATERIAL);
			glTranslatef(0.0, 0.0,-2.0);
			glmDraw(astronaut, GLM_SMOOTH | GLM_MATERIAL);
			glTranslatef(0.0, 5.0, 5.0);
			glmDraw(MarsRover, GLM_SMOOTH | GLM_MATERIAL);
			glTranslatef(0.0, 5.0, 0.0);
			glmDraw(Satellite, GLM_SMOOTH | GLM_MATERIAL);
			glTranslatef(0.0, 0.0, 0.0);
			glmDraw(Spaceship, GLM_SMOOTH | GLM_MATERIAL);
